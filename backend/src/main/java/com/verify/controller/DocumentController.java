...
public class DocumentController {
        ...
        @PostMapping("/verify")
        public Map<String, String> verify(@RequestParam("file") MultipartFile file) throws Exception {
        ...
        public List<Map<String, Object>> docs() {
                ...
                for (Document d : repo.findByCollegeId(collegeId)) {
